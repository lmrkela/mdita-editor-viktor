...
namespace StatistikaProjekata
{
    public class MyXmlNamespaceManager : XmlNamespaceManager
    {
        ...
        public MyXmlNamespaceManager(XmlNameTable nameTable, string missingNamespacePrefix)
            : base(nameTable)
        {
            MissingNamespacePrefix = (string.IsNullOrEmpty(missingNamespacePrefix) ? DefaultMissingNamespacePrefix : missingNamespacePrefix);
            MissingNamespaces = new Dictionary<string, List<string>>();
        }
        ...
        void AddMissingNamespace(string prefix)
        {
            ...
            do
            {
                var index = NextMissingNamespaceIndex++;
