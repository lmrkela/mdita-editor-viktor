...
<xsl:value-of select="$newline"/><xsl:comment>TopicType ===== <xsl:value-of select="@class"/> === END ===</xsl:comment><xsl:value-of select="$newline"/>
</xsl:template>
...
<!-- IRVAS izbacen shortdesc za potrebe pdf-a
  <p>
    <xsl:call-template name="commonattributes"/>
    <xsl:apply-templates/>
...
<xsl:variable name="ttype">
  ...
  <xsl:if test="$ttype='LC' and not(contains(@class, 'Objectives'))">
  ...
  <xsl:if test="$ttype='LS' and not(contains(@class, 'Objectives'))">
    <xsl:value-of select="$newline"/><xsl:comment>IRVAS LO SECTION</xsl:comment><xsl:value-of select="$newline"/>
    <div class="sadrzaj_column">
      <xsl:call-template name="commonattributes"/>
      <xsl:call-template name="gen-toc-id"/>
...
<xsl:template match="*[contains(@class,' topic/video ')]">
	<p>
        <xsl:call-template name="commonattributes"/>
        <xsl:call-template name="setidaname"/>
		<b>Ova lekcija sadrži video materijal. Ukoliko želite da pogledate ovaj video morate da otvorite LAMS lekciju.</b>
    </p>
</xsl:template>
...
<xsl:template match="*[contains(@class,' topic/audio ')]">
	<p>
        <xsl:call-template name="commonattributes"/>
        <xsl:call-template name="setidaname"/>
		<b>Ova lekcija sadrži audio materijal. Ukoliko želite da pogledate ovaj audio morate da otvorite LAMS lekciju.</b>
    </p>
</xsl:template>
...
<xsl:template match="*[contains(@class, ' topic/p ')]" name="topic.p">
 ...
 <xsl:choose>
  <xsl:when test="descendant::*[contains(@class, ' topic/pre ')] or
       ...
       descendant::*[contains(@class, ' topic/lq ')] or
       descendant::*[contains(@class, ' topic/dl ')] or
       descendant::*[contains(@class, ' topic/p ')] or
       descendant::*[contains(@class, ' topic/br ')] or
       descendant::*[contains(@class, ' topic/note ')] or
       descendant::*[contains(@class, ' topic/lines ')] or
       descendant::*[contains(@class, ' topic/fig ')] or
...
<!--      <xsl:call-template name="processFTR"/>  IRVAS -->    <!-- Include XHTML footer, if specified -->
      <xsl:apply-templates select="*[contains(@class, ' ditaot-d/ditaval-endprop ')]" mode="out-of-line"/>
    </body>
    <xsl:value-of select="$newline"/>
  </xsl:template>
