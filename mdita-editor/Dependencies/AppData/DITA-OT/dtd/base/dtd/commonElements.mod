...
<!-- IRVAS -->
<!--                    LONG NAME: formuldiv content element         -->
<!ENTITY % formuldiv.content
                       "ANY
">
<!ENTITY % formuldiv.attributes
             "%univ-atts;
              outputclass
                        CDATA
                                  #IMPLIED"
>
<!ELEMENT formuldiv    %formuldiv.content;>
<!ATTLIST formuldiv    %formuldiv.attributes;>
...
<!ENTITY % font.content  "(%britem.cnt;)*"
>
...
<!ENTITY % youtube.content
                       "(%para.cnt;)*"
>
<!ENTITY % youtube.attributes
              "width 
                        CDATA 
                                  #IMPLIED
              height 
              ...
              src
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT youtube    %youtube.content;>
<!ATTLIST youtube    %youtube.attributes;>
...
<!ENTITY % slides.content
                       "(%para.cnt;)*"
>
<!ENTITY % slides.attributes
              "width 
                        CDATA 
                                  #IMPLIED
              height 
			  ...
			  type
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT slides    %video.content;>
<!ATTLIST slides    %video.attributes;>

<!ENTITY % galleryimage.content
                       "(%para.cnt;)*"
>
<!ENTITY % galleryimage.attributes
              "width 
                        CDATA 
                                  #IMPLIED
              height 
			  ...
			  type
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT galleryimage    %galleryimage.content;>
<!ATTLIST galleryimage    %galleryimage.attributes;>
...
<!ATTLIST youtube   %global-atts;  class CDATA "- topic/youtube "     >
<!ATTLIST video     %global-atts;  class CDATA "- topic/video "     >
<!ATTLIST galleryimage      %global-atts;  class CDATA "- topic/galleryimage "     >
<!ATTLIST audio     %global-atts;  class CDATA "- topic/audio "     >
...
<!ATTLIST br        %global-atts;  class CDATA "- topic/br "         >
<!ATTLIST font      %global-atts;  class CDATA "- topic/font "       >
...
<!ATTLIST slides        %global-atts;  class CDATA "- topic/slides "         >
