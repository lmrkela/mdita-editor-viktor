...
{
    public partial class ShareResourcesAddUrlControl : UserControl
    {
        private ShareResourcesForm ParentControl;
        ...
        public ShareResourcesAddUrlControl()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        public ShareResourcesAddUrlControl(LamsShareResource.ResourceItem resourceItem, ShareResourcesForm parent)
        {
            InitializeComponent();
            Disposed += OnDisposed;
        ...
        public ShareResourcesAddUrlControl(LamsShareResource.ResourceItemInstruction resourceItemInstruction, ShareResourcesForm parent)
        {
            InitializeComponent();
            Disposed += OnDisposed;
